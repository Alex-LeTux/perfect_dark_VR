...
struct player {
    ...
    /*0x0090*/ f32 crouchtime240; // VR /*0x0090*/ s32 crouchtime240; // Set to 60 when landing, counts down
    ...
    /*0x19ac*/ f32 crouchoffsetreal; // VR /*0x19ac*/ s32 crouchoffsetreal;
    /*0x19b0*/ RoomNum floorroom;
    /*0x19b2*/ u8 unk19b2;
    /*0x19b3*/ u8 dostartnewlife;
    /*0x19b4*/ f32 crouchoffsetsmall;
    /*0x19b8*/ f32 crouchoffsetrealsmall; // VR s32 crouchoffsetrealsmall; // 0 = standing, -90 = squatting, can be between during transition
...
struct movedata {
    ...
    /*0x64*/ f32 crouchdown; // VR /*0x64*/ s32 crouchdown;
    /*0x68*/ f32 crouchup;  // VR /*0x68*/ s32 crouchup;
    /*0x6c*/ bool rleanleft;
