...
void bmoveProcessInput(bool allowc1x, bool allowc1y, bool allowc1buttons, bool ignorec2) {
    ...
    if (g_Vars.currentplayer->joybutinhibit & 0xffffffff) {
        ...
        g_Vars.currentplayer->joybutinhibit =
                (g_Vars.currentplayer->joybutinhibit & 0x0) | inhibitedbuttons;
    }
    ...
    if (allowc1buttons && g_Vars.currentplayer->isdead == false &&
    ...
    if (g_Vars.currentplayer->pausemode == PAUSEMODE_UNPAUSED) {
        if (g_Vars.currentplayer->isdead == false) {
            if (controlmode == CONTROLMODE_23 || controlmode == CONTROLMODE_24 ||
                controlmode == CONTROLMODE_22 || controlmode == CONTROLMODE_21) {
                ...
                if (optionsGetAimControl(g_Vars.currentplayerstats->mpindex) == AIMCONTROL_HOLD) {
                    for (i = 0; i < numsamples; i++) {
                        aimonhist[i] = allowc1buttons &&
                                       joyGetButtonsOnSample(i, aimpad, aimallowedbuttons & Z_TRIG);
                ...
                if (!lvIsPaused()) {
                    // Handle aiming
                    if (optionsGetAimControl(g_Vars.currentplayerstats->mpindex) !=
                        AIMCONTROL_HOLD) {
                        for (i = 0; i < numsamples; i++) {
                            if (allowc1buttons && joyGetButtonsPressedOnSample(i, aimpad,
                                                                               aimallowedbuttons &
                                                                               Z_TRIG)) {
                        ...
                        if (g_Vars.currentplayer->invdowntime < -2) {
                            ...
                            for (i = 0; i < numsamples; i++) {
                                if (controlmode == CONTROLMODE_PC) {
                                    if (joyGetButtonsPressedOnSample(i, contpad1, c1allowedbuttons &
                                                                                  BUTTON_WPNFORWARD)) {
                                        movedata.weaponforwardoffset++;
                                        g_Vars.currentplayer->invdowntime = -1;
                                    } else if (joyGetButtonsPressedOnSample(i, contpad1,
                                                                            c1allowedbuttons &
                                                                            BUTTON_WPNBACK)) {
                                ...
                                if (joyGetButtonsOnSample(i, contpad1, c1allowedbuttons & A_BUTTON)
                                    || joyGetButtonsOnSample(i, contpad2,
                                                             c2allowedbuttons & A_BUTTON)) {
                                    if (g_Vars.currentplayer->invdowntime > -2) {
                                        if (joyGetButtonsPressedOnSample(i, shootpad,
                                                                         shootallowedbuttons &
                                                                         Z_TRIG)) {
                                            movedata.weaponbackoffset++;
                                            g_Vars.currentplayer->invdowntime = -1;
                                        ...
                                        if (g_Vars.currentplayer->invdowntime > -1
                                            && joyGetButtonsOnSample(i, shootpad,
                                                                     shootallowedbuttons &
                                                                     Z_TRIG) == 0) {
                                    ...
                                    if (g_Vars.currentplayer->invdowntime > 0 &&
                                        (!allowc1buttons || joyGetButtonsOnSample(i, shootpad,
                                                                                  shootallowedbuttons &
                                                                                  Z_TRIG) == 0)) {
                                        movedata.weaponforwardoffset++;
                                    }
                        ...
                        for (i = 0; i < numsamples; i++) {
                            if (joyGetButtonsOnSample(i, contpad1, c1allowedbuttons & B_BUTTON)
                                ...
                                if (g_Vars.currentplayer->usedowntime >= -1) {
                                    if (joyGetButtonsPressedOnSample(i, shootpad,
                                                                     shootallowedbuttons & Z_TRIG)
                                        && g_Vars.currentplayer->usedowntime > -1
                                        && bgunConsiderToggleGunFunction(
                                            g_Vars.currentplayer->usedowntime, true, false, 0) !=
                                           USETIMER_CONTINUE) {
                                    ...
                                    if (g_Vars.currentplayer->usedowntime > -1) {
                                        if (g_Vars.currentplayer->usedowntime > TICKS(25)) {
                                            result = bgunConsiderToggleGunFunction(
                                                    g_Vars.currentplayer->usedowntime, false, false,
                                                    0);
                                    ...
                                    bgunConsiderToggleGunFunction(g_Vars.currentplayer->usedowntime,
                                                                  false, false, 0);
                                }
                            } else {
                    ...
                    if (canmanualzoom && g_Vars.currentplayer->insightaimmode) {
                        if (c2sticky < 0) {
                            ...
                            movedata.zoomoutfovpersec =
                                    movedata.zoomoutfovpersec + movedata.zoomoutfovpersec;
                        }
                        ...
                        if (c2sticky > 0) {
                            ...
                            movedata.zoominfovpersec =
                                    movedata.zoominfovpersec + movedata.zoominfovpersec;
                        }
                    }
                    ...
                    if (allowc1buttons) {
                        for (i = 0; i < numsamples; i++) {
                            if (!canmanualzoom && aimonhist[i]) {
                                if (joyGetStickYOnSample(i, contpad2) > 30 &&
                                    joyGetStickYOnSampleIndex(i, contpad2) <= 30) {
                ...
                if (optionsGetAimControl(g_Vars.currentplayerstats->mpindex) == AIMCONTROL_HOLD) {
                    for (i = 0; i < numsamples; i++) {
                        aimonhist[i] = allowc1buttons && joyGetButtonsOnSample(i, contpad1,
                                                                               aimbuttons &
                                                                               c1allowedbuttons);
                        aimoffhist[i] = !aimonhist[i];
                    }
                ...
                if (!lvIsPaused()) {
                    ...
                    if (optionsGetAimControl(g_Vars.currentplayerstats->mpindex) !=
                        AIMCONTROL_HOLD) {
                        for (i = 0; i < numsamples; i++) {
                            if (allowc1buttons && joyGetButtonsPressedOnSample(i, contpad1,
                                                                               aimbuttons &
                                                                               c1allowedbuttons)) {
                                g_Vars.currentplayer->insightaimmode = !g_Vars.currentplayer->insightaimmode;
                            }
...
#ifdef ANDROID
                        //Vr button X prev weapon
                        bool VR_BUTTON_X = get_button_state(0, "x");
                        if (VR_BUTTON_X && !Prev_VR_BUTTON_X) {
                            movedata.weaponbackoffset++;
                        }
                        Prev_VR_BUTTON_X = VR_BUTTON_X;
#endif
...
//                            if (allowc1buttons) {
//                                movedata.digitalstepleft = joyCountButtonsOnSpecificSamples(
//                                        aimoffhist, contpad1, c1allowedbuttons & slmask);
//                                movedata.digitalstepright = joyCountButtonsOnSpecificSamples(
//                                        aimoffhist, contpad1, c1allowedbuttons & srmask);
//                            }
//                        } else {
...
//                                !g_Vars.currentplayer->insightaimmode && (c1buttons & sumask);
//                        movedata.digitalstepback =
//                                !g_Vars.currentplayer->insightaimmode && (c1buttons & sdmask);
//                        movedata.canlookahead = (controlmode == CONTROLMODE_PC) &&
...
//                            movedata.cannaturalpitch = true;
...
#ifndef PLATFORM_N64
                        if (controlmode == CONTROLMODE_PC) {
                            if ((g_Vars.currentplayer->devicesactive & DEVICE_EYESPY) ||
                                g_Vars.currentplayer->visionmode > 1 || g_Vars.tickmode != 1) {
                                movedata.analogturn = 0;
                                movedata.analogpitch = 0;
                                movedata.analogstrafe = 0;
                                movedata.analogwalk = 0;
                            ...
                            if (PLAYER_EXTCFG().mouseaimmode == MOUSEAIM_LOCKED ||
                                ...
                                movedata.cannaturalpitch =
                                        movedata.cannaturalpitch || (movedata.freelookdy != 0.0f);
                                movedata.cannaturalturn =
                                        movedata.cannaturalturn || (movedata.freelookdx != 0.0f);
                            }
                        }
#endif
                        ...
                        if (!g_Vars.currentplayer->insightaimmode && allowc1buttons) {
                            movedata.digitalstepleft = joyCountButtonsOnSpecificSamples(aimoffhist,
                                                                                        contpad1,
                                                                                        c1allowedbuttons &
                                                                                        (L_JPAD |
                                                                                         L_CBUTTONS));
                            movedata.digitalstepright = joyCountButtonsOnSpecificSamples(aimoffhist,
                                                                                         contpad1,
                                                                                         c1allowedbuttons &
                                                                                         (R_JPAD |
                                                                                          R_CBUTTONS));
                        ...
                        // Looking up/down
                        if (!g_Vars.currentplayer->insightaimmode &&
                            (c1buttons & (U_JPAD | U_CBUTTONS))) {
                            movedata.speedvertadown = 1;
                        }

                        if (!g_Vars.currentplayer->insightaimmode &&
                            (c1buttons & (D_JPAD | D_CBUTTONS))) {
                            movedata.speedvertaup = 1;
                        }
                    ...
                    if (g_Vars.currentplayer->insightaimmode && allowmcross &&
                        ...
                        if (g_Vars.currentplayer->swivelpos[0] > 0.9f) {
                            movedata.aimturnrightspeed =
                                    (g_Vars.currentplayer->swivelpos[0] - 0.9f) / 0.1f;
                            movedata.aimturnleftspeed = 0.f;
                        } else if (g_Vars.currentplayer->swivelpos[0] < -0.9f) {
                            movedata.aimturnleftspeed =
                                    (g_Vars.currentplayer->swivelpos[0] - -0.9f) / -0.1f;
...
#endif
                                if (joyGetButtonsOnSample(i, contpad1,
                                                          invbuttons & c1allowedbuttons)) {
                                    if (g_Vars.currentplayer->invdowntime > -2) {
                                        if (joyGetButtonsPressedOnSample(i, contpad1, shootbuttons &
                                                                                      c1allowedbuttons)) {
                                            movedata.weaponbackoffset++;
                                            g_Vars.currentplayer->invdowntime = -1;
                                        }
                                        ...
                                        if (g_Vars.currentplayer->invdowntime >= 0 &&
                                            joyGetButtonsOnSample(i, contpad1, shootbuttons &
                                                                               c1allowedbuttons) ==
                                            0) {
                                    ...
                                    if (g_Vars.currentplayer->invdowntime > 0 &&
                                        (!allowc1buttons || joyGetButtonsOnSample(i, contpad1,
                                                                                  shootbuttons &
                                                                                  c1allowedbuttons) ==
                                                            0)) {
                                ...
                                if (g_Vars.currentplayer->usedowntime >= -1) {
                                    if (controlmode != CONTROLMODE_PC) {
                                        if (joyGetButtonsPressedOnSample(i, contpad1, shootbuttons &
                                            ...
                                            && g_Vars.currentplayer->usedowntime >= 0
                                            && bgunConsiderToggleGunFunction(
                                                g_Vars.currentplayer->usedowntime, true, false,
                                                0) != USETIMER_CONTINUE) {
                                            g_Vars.currentplayer->usedowntime = -3;
                                        }
                                    }
                                    ...
                                    if ((controlmode != CONTROLMODE_PC) &&
                                        g_Vars.currentplayer->usedowntime >= -2) {
                                        bgunConsiderToggleGunFunction(
                                                g_Vars.currentplayer->usedowntime, false, false, 0);
                                    }
                                }
                            } else {
                                // Released B
...
//                        for (i = 0; i < numsamples; i++) {
//                            if (joyGetButtonsOnSample(i, contpad1,
//                                                      c1allowedbuttons & BUTTON_RELOAD)) {
...
//                        }
                        ...
                        for (i = 0; i < numsamples; i++) {
                            if (joyGetButtonsOnSample(i, contpad1,
                                                      c1allowedbuttons & BUTTON_RADIAL)) {
                                if (g_Vars.currentplayer->amdowntime < -2) {
                                    ...
                                    if (g_Vars.currentplayer->amdowntime >= 0) {
                                        if (joyGetButtonsPressedOnSample(i, contpad1,
                                                                         c1allowedbuttons &
                                                                         BUTTON_RADIAL)) {
                                            amOpen();
                        ...
                        for (i = 0; i < numsamples; i++) {
                            ...
                            if (PLAYER_EXTCFG().crouchmode & CROUCHMODE_TOGGLE) {
                                ...
                                crouchsample =
                                        joyGetButtonsPressedOnSample(i, contpad1, 0xffffffff) &
                                        BUTTON_CROUCH_CYCLE;
                                if (crouchsample) {
                                ...
                                crouchsample = joyGetButtonsPressedOnSample(i, contpad1,
                                                                            c1allowedbuttons) &
                                               BUTTON_HALF_CROUCH;
                                if (crouchsample) {
                                ...
                                // hold to crouch
                                crouchsample =
                                        joyGetButtonsOnSample(i, contpad1, c1allowedbuttons) &
                                        (BUTTON_FULL_CROUCH | BUTTON_HALF_CROUCH);
                                if (!crouchsample) {
                                    g_Vars.currentplayer->crouchpos = CROUCHPOS_STAND;
                        ...
                        while (g_Vars.currentplayer->crouchpos > oldcrouchpos &&
                               !bwalkCanUncrouch()) {
                            g_Vars.currentplayer->crouchpos--;
                        }
                    }
...
#else
                    if (allowc1buttons && (controlmode != CONTROLMODE_PC ||
                                           (PLAYER_EXTCFG().crouchmode & CROUCHMODE_ANALOG))) {
#endif
                        for (i = 0; i < numsamples; i++) {
                            if (!canmanualzoom && aimonhist[i]) {
                                bool goUp = joyGetButtonsPressedOnSample(i, contpad1,
                                                                         c1allowedbuttons & sumask);
                                if (controlmode == CONTROLMODE_PC) {
                                    goUp = goUp || ((joyGetRStickYOnSample(i, contpad1) > 30 &&
                                                     joyGetRStickYOnSampleIndex(i, contpad1) <=
                                                     30));
                                }
                                if (goUp) {
                                    if (movedata.crouchdown) {
                                ...
                                bool goDn = joyGetButtonsPressedOnSample(i, contpad1,
                                                                         c1allowedbuttons & sdmask);
                                if (controlmode == CONTROLMODE_PC) {
                                    goDn = goDn || ((joyGetRStickYOnSample(i, contpad1) < -30 &&
                                                     joyGetRStickYOnSampleIndex(i, contpad1) >=
                                                     -30));
                                }
                                if (goDn) {
                    ...
                    if (bgunGetWeaponNum(HAND_RIGHT) == WEAPON_FARSIGHT) {
                        ...
                        movedata.rleanleft =
                                g_Vars.currentplayer->insightaimmode && (c1buttons & slmask);
                        movedata.rleanright =
                                g_Vars.currentplayer->insightaimmode && (c1buttons & srmask);
#ifndef PLATFORM_N64
                        if (controlmode == CONTROLMODE_PC && g_Vars.currentplayer->insightaimmode) {
                    ...
                    if (controlmode != CONTROLMODE_PC) {
                        ...
                        bgunProcessQuickDetonate(&movedata, c1buttons, c1buttonsthisframe,
                                                 (BUTTON_CANCEL_USE | BUTTON_ACCEPT_USE),
                                                 (BUTTON_WPNBACK | BUTTON_RADIAL | BUTTON_RELOAD));
                    }
                }
    ...
    if (controlmode == CONTROLMODE_PC && movedata.alt1tapcount) {
        g_Vars.currentplayer->bondactivateorreload =
    ...
    if (movedata.btapcount) {
        ...
        if (!usereloads) {
            ...
            g_Vars.currentplayer->bondactivateorreload = movedata.btapcount ?
                                                         (g_Vars.currentplayer->bondactivateorreload |
                                                          JO_ACTION_ACTIVATE | JO_ACTION_RELOAD)
                                                                            : 0;
        }
    ...
    if (g_Vars.currentplayer->pausemode == PAUSEMODE_UNPAUSED && !g_MainIsEndscreen) {
        ...
        if (bgunGetWeaponNum(HAND_RIGHT) == WEAPON_FARSIGHT
            ...
            mtx4TransformVec(camGetWorldToScreenMtxf(),
                             &g_Vars.currentplayer->autoerasertarget->pos, &spa0);
    ...
    if (g_Vars.currentplayer->pausemode == PAUSEMODE_UNPAUSED) {
            ...
            if (movedata.speedvertadown > 0 || movedata.speedvertaup > 0) {
                ...
                if (movedata.disablelookahead) {
                    ...
                    if (g_Vars.currentplayer->automovecentre
                        && (g_Vars.currentplayer->vv_verta > lookahead + 5.0f ||
                            g_Vars.currentplayer->vv_verta < lookahead + -10.0f)
                        && g_Vars.currentplayer->movecentrerelease == false) {
        ...
        if (g_Vars.currentplayer->docentreupdown) {
            if (offbike) {
                ...
                increment2 = (g_Vars.currentplayer->speedverta * g_Vars.currentplayer->speedverta *
                              0.5f) / 0.05f;
                ...
                // Calculate new verta
                newverta = g_Vars.currentplayer->vv_verta +
                           (g_Vars.currentplayer->speedverta * g_Vars.lvupdate60freal +
                            g_Vars.currentplayer->speedverta * g_Vars.lvupdate60freal);

//                if (g_Vars.currentplayer->vv_verta > lookahead && newverta > lookahead) { // Removed for  VR
...
//                }
            ...
            // g_Vars.currentplayer->vv_verta += g_Vars.currentplayer->speedverta * g_Vars.lvupdate60freal * 3.5f;  Removed for VR
        }
    }
    ...
    if (g_Vars.currentplayer->unk1c64) {
        ...
        if (
                ...
                || (bgunGetWeaponNum(HAND_RIGHT) == WEAPON_CMP150 &&
                    g_Vars.currentplayer->hands[HAND_RIGHT].gset.weaponfunc == FUNC_SECONDARY)) {
            ...
            if (g_Vars.currentplayer->autoaimdamp > (PAL ? 0.955f : 0.963f)) {
                g_Vars.currentplayer->autoaimdamp -=
                        (PAL ? 0.00037999986670911f : 0.00031999943894334f) *
            ...
            x = g_Vars.currentplayer->speedtheta * 0.3f * xscale +
                g_Vars.currentplayer->gunextraaimx;
            y = -g_Vars.currentplayer->speedverta * 0.1f * yscale +
